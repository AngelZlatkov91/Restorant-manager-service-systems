...
export default function OrderClient() {
  ...
  const isOwnerOrAdmin =
    activeOrder.personalName === personal.name ||
    personal.role === "ADMIN";
    ...
    <div className="order-wrapper">
      <header className="order-header">
        ...
        <div className="order-header-right">
          <span style={{ color: "black" }}>{personal.name}</span>
          {!hasProduct && (
      ...
      <div className="order-main">
        ...
        {isOwnerOrAdmin && (
          <div className="order-actions">
            ...
            <button className="save-btn" onClick={createOrUpdate}>
              Запази / Актуализирай
            </button>
          </div>
        )}
